 ...
 *   
 *   moisture sensor plugged into A0
 *   
 *   
 *   +++process+++
 *   load all the things.
 *   get all bits started and working.
 *   check rtc for the time.
 *   check the moisture sensor
 *   update the display based on time or dryness warning.
 *   fade light on if it's "dawn".
 *   fade light if it's "dusk".
